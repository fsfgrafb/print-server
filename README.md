...
6. 选择打印范围：全部、奇数页、偶数页。
7. 点击“提交”。
8. 在“打印队列”查看任务状态和个人历史；可勾选“只看我的打印”。普通用户只能预览自己的最终打印 PDF，其他人的文件名与预览不可见。
...
“打印队列”向所有登录用户显示全部用户近一年的记录，并支持按学号筛选和“只看我的打印”。普通用户不能查看他人文件名或最终 PDF 预览；管理员可查看全部文件名和预览，并额外拥有暂停/继续队列、取消他人任务和审批操作。
